...
You implement in `frontend/` only. Follow `.codex/specs/frontend-conventions.md` and
...
- Before declaring anything done: `npm run lint && npm test && npm run build` all pass, AND
  a self-check against `.codex/specs/frontend-conventions.md`'s review checklist — don't
