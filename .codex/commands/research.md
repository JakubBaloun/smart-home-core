...
- `.codex/specs/backend-conventions.md` — Python style, typing, packages, config, Flyway
- `.codex/specs/architecture-patterns.md` — layering, sessions, wiring, parity contract
- `.codex/specs/frontend-conventions.md` — modules, tokens, routing, API layer
- `.codex/specs/mqtt-patterns.md` — paho-mqtt, Zigbee2MQTT topics, consumers, commands
- `.codex/specs/testing-patterns.md` — pytest + testcontainers, Vitest

Prefer an established pattern over a new one.

### 3. Check the documentation

- Root `AGENTS.md` — tech stack, critical invariants, deployment
...
- Anything from `AGENTS.md` "Critical invariants" that this touches
