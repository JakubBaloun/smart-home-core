...
You implement in `backend-python/` only. Follow `.claude/specs/backend-conventions.md` and
the "Critical Patterns" section of root `CLAUDE.md` exactly — those invariants (bool-before-
